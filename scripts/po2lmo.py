#!/usr/bin/env python3
# PO to LMO converter — SuperFastHash-based binary format for Xiaomi LuCI i18n
# Source: https://github.com/openwrt-xiaomi/xmir-patcher
# License: Same as xmir-patcher (SuperFastHash by Paul Hsieh, LGPLv2.1)
